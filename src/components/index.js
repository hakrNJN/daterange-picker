...
//   const calculateCalendarPosition = (isVisible) => {
//     const { current } = calendar_ref;
...
//     const style = calculateCalendarPosition(!showCalendar);
...
//   const style = calculateCalendarPosition(showCalendar || (isVisibilityControlled && visible));

//   return (
//     <Provider>
//       <div className="date-picker-app-wrapper" ref={calendar_ref}>
...
//         </div>
//         {createPortal(
//           <div style={style} className={`calendar${showCalendar ? ' visible' : ''}`} ref={popup_ref}>
//             <Calendar
//               {...this.props}
//               onDateSelected={this.onDateSelected}
//               isVisible={visible}
...
//             />
//           </div>,
//           document.getElementById('__range-picker-container')
//         )}
//       </div>
//     </Provider>
//   );
